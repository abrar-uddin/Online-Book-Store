...
export class Cart extends Component {
    ...
    render() {
        return (
            <div className="container" onLoad={this.checkRequired}>
                <h2>Cart Items</h2>
                    ...
                    <form id="checkout_form" className="col s12">
                        <div className="row">
                            ...
                            <div className="input-field col s6">
                                <input id="first_name" type="text" className="validate" onKeyUp={this.checkRequired}
                                       required></input>
                                <label htmlFor="first_name">First Name</label>
                            </div>
                            <div className="input-field col s6">
                                <input id="last_name" type="text" className="validate" onKeyUp={this.checkRequired}
                                       required></input>
                        ...
                        <div className="row">
                            <div className="input-field col s12">
                                <input id="address" type="text"
                                       className="validate" onKeyUp={this.checkRequired} required></input>
                        ...
                        <div className="row">
                            ...
                            <div className="input-field col s3">
                                <input id="full_name" type="text" className="validate" onKeyUp={this.checkRequired}
                                       required></input>
                        ...
                        <div className="row">
                            <div className="input-field col s5">
                                ...
                                <input id="exp_date" type="text" className="datepicker" onChange={this.checkRequired}
                                       required></input>
                                <label htmlFor="exp_date">Expiration Date</label>
                            </div>
                            <div className="input-field col s5">
                                <input id="cvv" type="tel" className="validate" onKeyUp={this.checkRequired}
                                       required></input>
                            ...
                            <div className="row" visibility="hidden">
                                <div className="input-field col s6">
                                    <input id="shipping_first_name" type="text" className="validate"
                                           onKeyUp={this.checkRequired} required></input>
